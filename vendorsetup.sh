...
git clone -b lineage-23.0 https://github.com/droidcore/vendor_xiaomi_peridot.git vendor/xiaomi/peridot
...
git clone https://github.com/GuidixX/packages_apps_XiaomiParts.git packages/apps/XiaomiParts
